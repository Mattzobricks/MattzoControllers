...
BLELocomotiveConfiguration *deserializeLocoConfig(JsonObject locoConfig, std::vector<MCChannelConfig *> espPins, int16_t defaultPwrIncStep, int16_t defaultPwrDecStep)
{
